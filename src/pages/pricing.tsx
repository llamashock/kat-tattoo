...
const pricing = () => {
    ...
    <Layout>
        ...
        <p className={`${styles.p}`}>Please note: All appointments require a non-refundable deposit of $100, which will be applied toward the price of the tattoo.
        If you need to reschedule, you must give more than 48 hours notice, and this deposit will be applied to the new appointment time.
        (If multiple sessions are required for the tattoo, the deposit will be applied to the last session.)</p>
    </Layout>
    )
}
